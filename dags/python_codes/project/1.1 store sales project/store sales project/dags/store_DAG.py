...
with DAG('store_dag_1',default_args=default_args,schedule_interval='@daily', 
         tags=['project'], template_searchpath=['/usr/local/airflow/sql_files'], catchup=True) as dag:
